...
export default function VerifyEmail() {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="relative w-full max-w-md p-8 rounded-2xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_0_60px_rgba(0,0,0,0.8)] text-center">

        {/* ICON */}
        <div className="flex justify-center mb-6">
          {status === 'success' && <CheckCircle2 className="text-emerald-400" size={50} />}
          {status === 'error' && <XCircle className="text-red-400" size={50} />}
          {status === 'loading' && <Loader2 className="animate-spin text-cyan-400" size={50} />}
        </div>
        ...
        {status === 'success' && (
          <>
            ...
            <Link
              to="/"
              className="w-full inline-block py-3.5 rounded-xl font-semibold text-white
              bg-gradient-to-r from-teal-500 to-cyan-500
              shadow-lg shadow-cyan-500/30
              hover:shadow-cyan-500/50 hover:scale-[1.03] active:scale-[0.97]
